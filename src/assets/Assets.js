...
export const Assets = ({setOpenAsset}) => {
    ...
    return (
        <div>
          ...
          <Table handleOpen={setOpenAsset} handleDelete={handleDelete} rows={mappedData} columns={['Name', 'Amount', 'Rate']} keys={['name', 'amount', 'interest_rate']} />
        </div>
    )
}